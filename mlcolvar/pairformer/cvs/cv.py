...
from mlcolvar.pairformer.core.nn import models

"""
Base collective variable class for Pairformer.
"""

__all__ = ['PairBaseCV']


class PairBaseCV(lightning.LightningModule):
    """
    Base collective variable class for Pairformer.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.save_hyperparameters(ignore=['n_cvs', 'mapping_names'])
