...
@torch.jit.ignore
def _tri_additive_linear_attention(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    biases: List[torch.Tensor],
):
    """Compute additive linear triangle attention with Triton when available."""
    from .kernel import additive_linear_attention_run
    ...
    o = additive_linear_attention_run(q, k, v, biases[0], biases[1])
    o = o.reshape(orig_shape)
...
@torch.jit.ignore
def _tri_gated_linear_attention(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    biases: List[torch.Tensor],
):
    """Compute gated linear triangle attention with Triton when available."""
    from .kernel import gated_linear_attention_run
    ...
    o = gated_linear_attention_run(q, k, v, biases[0], biases[1])
    o = o.reshape(orig_shape)
